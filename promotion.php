...
//    $update_price = $_POST['update_price'];
   ...
   mysqli_query($conn, "UPDATE `promotions` SET name = '$update_name'") or die('query failed');
   ...
   if(!empty($update_image)){
      if($update_image_size > 2000000){
         ...
         mysqli_query($conn, "UPDATE `promotions` SET image = '$update_image' WHERE id = '$update_p_id'") or die('query failed');
...
<section class="show-products">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <a href="promotion.php?delete=<?php echo $fetch_products['id']; ?>" class="delete-btn" onclick="return confirm('delete this product?');">delete</a>
      </div>
      <?php
         }
      }else{
